...
if (isset($_SESSION['login'])) {
    header('location: userdashboard?mn=1.php');
}
        ...
        <div class="container mt-5">
            <div class="row">
                <div class="col-12 col-sm-8 col-md-6 m-auto">
                    <div class="card">
                        <div class="card-body">
                            <form action="userregisterproses.php" method="post">
                                <label for="" class="d-block text-center mb-4 fs-4">User Register</label>
                                ...
                                <div class="text-center mt-3">
                                    <a href="userloginpage.php" class="nav-link">Already have an account? Log in here</a>
                                </div>
                            </form>
                        </div>
                    </div>
