...
$query = "SELECT * FROM listorder WHERE status = '$status'";
...
<div class="container">
    ...
    <div class="table-responsive" style="max-width: 100%; overflow-x: auto;"> <!-- Tambahkan overflow-x -->
            ...
            <tbody>
                ...
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td><a href='" . htmlspecialchars($row['bukti_transfer']) . "' class='btn-view' target='_blank'>Lihat</a></td>";
